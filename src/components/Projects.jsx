    ...
    <div className="bg-white rounded-lg shadow-md p-6">
      ...
      {isEditing && (
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 mb-6">
          <h3 className="font-semibold mb-4 text-gray-700">Add New Project</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {projects.map((project) => (
          <div key={project.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-lg transition duration-200">
            ...
            <div className="flex space-x-3">
              {project.liveUrl && (
                <a
                  ...
                  className="inline-flex items-center px-3 py-1 bg-blue-500 text-white text-sm rounded-md hover:bg-blue-600 transition duration-200"
                >
              ...
              {project.githubUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center px-3 py-1 bg-gray-700 text-white text-sm rounded-md hover:bg-gray-800 transition duration-200"
                >
